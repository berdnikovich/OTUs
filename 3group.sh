...
#dataPath="/home/berdnikovich/task/trimmed_galoread/R1_R2/3group"#_trimmed_fastqc.zip
# stage2 в /home/berdnikovich/task/trimmed_galoread/

#metadata for contigs
make.file(inputdir=/home/berdnikovich/task/trimmed_galoread/R1_R2/3group, type=gz, prefix=stability)
...
screen.seqs(fasta=stability.trim.contigs.fasta, count=stability.contigs.count_table, maxambig=0, maxlength=255, maxhomop=8)
